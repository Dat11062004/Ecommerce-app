...
const Collection = () => {
  ...
  // Thêm các lựa chọn dc tích vào mảng category
  ...
  // Thêm các lựa chọn dc tích vào mảng subCategory
  ...
  // Tạo ra 1 mảng products bản sao để lưu trữ danh sách các product sau khi lọc
  const applyFilter = () => {
